...
CONFIG = {
    ...
    "features": {
        ...
        "derived_probability_features": {
            "enabled": False,
            "models_directory": "research_vol/trained_models",  # Directory to scan
    ...
    "targets": {
        ...
        "to_process": {
            ...
            ## Volatility forecasting (regression target, -1 = use RMSE not Quantile)
            "next_24h_vol": [-1],  # Sentinel: -1 means regression mode, not percentile classification
    ...
    "hpt": {
        ...
        "use_weighted_loss": False, # Re-evaluate if still desired for regression
